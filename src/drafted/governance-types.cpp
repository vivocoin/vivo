...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "VivoNetwork") type = VivoNetwork;
    if(strType == "VivoNetworkVariable") type = VivoNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == VivoNetwork) s = "VivoNetwork";
    if(type == VivoNetworkVariable) s = "VivoNetworkVariable";
