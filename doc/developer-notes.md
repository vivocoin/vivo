...
Vivo Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as Vivo Core, where everyone uses
...
pay attention to for reviewers of Vivo Core code.
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Vivo Core uses tinyformat, which is type safe. Leave them out to avoid confusion
